...
public class BuildNumberPreferenceController extends AbstractPreferenceController implements
    ...
    public void displayPreference(PreferenceScreen screen) {
        ...
        if (preference != null) {
            try {
                ...
                String HexagonRomVersion = getHexagonRomVersion();
                if (!HexagonRomVersion.equals("")){
                    sb.append("\n");
                    sb.append(HexagonRomVersion);
                }
    ...
    private String getHexagonRomVersion(){
        String buildDate = SystemProperties.get("org.hexagonrom.build_date","");
        String buildType = SystemProperties.get("org.hexagonrom.build_type","unofficial").toUpperCase();
